...
function initScene() {
    ...
    scene.background = new THREE.Color(0xA3AB78);
    // Create Camera 3D
    camera = new THREE.PerspectiveCamera(10, // FOV (FIELD OF VIEW)
    600 / 580, //(ASPECT)
        0.1, // (NEAR)
        1000);  // (FAR)
    // To Render
    ...
    */
    ...
    createFistModel("src/models/obj/puma/","11743_Soccer_Shoes_v1_l3.mtl","11743_Soccer_Shoes_v1_l3.obj");
    // **************************************************************
}
